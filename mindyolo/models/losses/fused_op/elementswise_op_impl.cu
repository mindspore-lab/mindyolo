...
#pragma unroll
    ...
    inline cudaError_t EightInputsTransit(Factory factory, uint n, OUT *out, const IN *in, const IN2 *in2, const IN3 *in3, const IN4 *in4, const IN5 *in5, const IN6 *in6, const IN7 *in7, const IN8 *in8,
                                          cudaStream_t stream)
    {
    ...
    inline cudaError_t EightInputs(FunctorT functor, uint n, OUT *out, const IN *in, const IN2 *in2, const IN3 *in3, const IN4 *in4, const IN5 *in5, const IN6 *in6, const IN7 *in7, const IN8 *in8,
                                   cudaStream_t stream)
    {
    ...
    inline cudaError_t FourInputsTransit(Factory factory, uint n, OUT *out, const IN *in, const IN2 *in2, const IN3 *in3, const IN4 *in4,
                                         cudaStream_t stream)
    {
    ...
    inline cudaError_t FourInputs(FunctorT functor, uint n, OUT *out, const IN *in, const IN2 *in2, const IN3 *in3, const IN4 *in4,
                                  cudaStream_t stream)
    {
    ...
    inline cudaError_t FiveInputsTransit(Factory factory, uint n, OUT *out, const IN *in, const IN2 *in2, const IN3 *in3, const IN4 *in4, const IN5 *in5,
                                         cudaStream_t stream)
    {
    ...
    inline cudaError_t FiveInputs(FunctorT functor, uint n, OUT *out, const IN *in, const IN2 *in2, const IN3 *in3, const IN4 *in4, const IN5 *in5,
                                  cudaStream_t stream)
    {
