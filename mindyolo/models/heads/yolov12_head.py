...
class YOLOv12Head(nn.Cell):
            ...
            [
                nn.SequentialCell(
                    [
                        nn.SequentialCell(
                            [
                                DWConv(x, x, 3, sync_bn=sync_bn),
                                ConvNormAct(x, c3, 1, sync_bn=sync_bn),
                            ]
                        ),
                        nn.SequentialCell([
                                DWConv(c3, c3, 3, sync_bn=sync_bn),
                                ConvNormAct(c3, c3, 1, sync_bn=sync_bn),
                            ]
                        ),
    ...
    def construct(self, x):
        # Performs forward pass of the YOLOv12Head module. Returns predicted bounding boxes and class probabilities
