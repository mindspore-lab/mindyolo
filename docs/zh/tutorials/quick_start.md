...
1. 从[模型仓库](../modelzoo/benchmark.md)中选择一个模型及其配置文件，例如， `./configs/yolov7/yolov7.yaml`.
2. 从[模型仓库](../modelzoo/benchmark.md)中下载相应的预训练模型权重文件。
...
*(4) 在CloudBrain上进行训练，请在[这里](./tutorials/cloud/modelarts_CN.md)查看*

### 部署

请在[部署](deployment.md)查看.
